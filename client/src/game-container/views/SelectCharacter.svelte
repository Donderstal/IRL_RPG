<script lang="ts">
    ...
    import { LH_NEWTOWN_APP_3_KEY, LH_CARS_MASTER_ROOM_KEY } from '../../resources/mapResources/leonard_heights/leonard_heights_res'; 
...
<div class="select-character">
    ...
    <div id="instance-settings" style="position:absolute; top:10%; left:5%;">
        ...
        <p><label for="map-selection" >Select starting location</label><select id="map-selection" name="map-selection" >
            ...
            <option value={LH_CARS_MASTER_ROOM_KEY}>Master rooms</option>
        </select></p>
    </div>
