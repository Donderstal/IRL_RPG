...
export const ANIM_FLAP_WINGS_POSITIONAL = "FLAP WINGS POSITIONAL";
...
// Speechbubble talking heads
export const ANIM_SPEECH_BUBBLE_TALKING_HEAD_1 = "ANIM_SPEECH_BUBBLE_TALKING_HEAD_1";
...
export const POSITIONAL_ANIMS = [
    ANIM_TURN_CIRCLE_POSITIONAL, ANIM_BACK_AND_FORTH_POSITIONAL, ANIM_BACK_AND_FORTH_STEP_POSITIONAL, ANIM_FLAP_WINGS_POSITIONAL
];

export const CHARACTER_IDLE_ANIMS = [ANIM_BACK_AND_FORTH_POSITIONAL, ANIM_BOP, ANIM_BLINK]
export const PIGEON_IDLE_ANIMS = [ANIM_BACK_AND_FORTH_POSITIONAL, ANIM_FLAP_WINGS_POSITIONAL]
