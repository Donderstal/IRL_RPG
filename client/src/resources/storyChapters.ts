...
export const STORY_EVENTS = [
    {
        ...
        interaction: [[
            ...
            [
                ...
                [[SceneAnimationType.animation, false, "LEFT_AND_RIGHT_STEP", DANCING_GRANNY_SPRITE, true]],
    ...
    },
    {
        ...
        interaction: [[
            ...
            [
                ...
                [[SceneAnimationType.cameraMoveToSprite, true, PLAYER_NAME, false], [SceneAnimationType.speak, true, "Oh no, I better get down there fast!", PLAYER_NAME], [SceneAnimationType.move, false, MAIN_CHAR_FRIEND_SPRITE, { col: 0, row: 10 }]]
            ]
        ]]
    },
    {
    ...
    },
    {
        ...
        interaction: [[
            ...
            [
                ...
                [[SceneAnimationType.speak, true, "I love being a thug, it's my dream job", THUG_A, THUG_B], [SceneAnimationType.cameraMoveToSprite, true, THUG_A, false], [SceneAnimationType.move, true, PLAYER_NAME, { col: 19, row: 9 }]],
