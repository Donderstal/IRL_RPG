import { CINSCRIPT_COLLECT_CAN, CINSCRIPT_COLLECT_COIN, CINSCRIPT_LOCKED_DOOR, CINSCRIPT_RANDOM_ENCOUNTER_1, CINSCRIPT_RANDOM_ENCOUNTER_2, CINSCRIPT_RANDOM_ENCOUNTER_3, CINSCRIPT_RANDOM_ENCOUNTER_4, CINSCRIPT_RANDOM_ENCOUNTER_5, CINSCRIPT_RANDOM_ENCOUNTER_6, CINSCRIPT_SAVE_GAME, CINSCRIPT_SAVE_NOT_LOGGED_IN, CINSCRIPT_UNLOCK_DOOR } from "./cinematicResources";
...
export const INTERACTION_SAVE_GAME          = [getDefaultTalkInteraction( CINSCRIPT_SAVE_GAME, getDefaultCondition() )];
export const INTERACTION_SAVE_NOT_LOGGED_IN = [getDefaultTalkInteraction( CINSCRIPT_SAVE_NOT_LOGGED_IN, getDefaultCondition() )];
