...
const { EVENT_HAS_NOT_FIRED } = require('../../../../game-data/conditionGlobals');
const { LOGGABLE_INTERACTION_3 } = require('../../../../game-data/interactionGlobals');
module.exports =
...
"characters":[
    {"anim_type":globals.NPC_ANIM_TYPE_IDLE,"row":3,"col":12,"sprite":"pigeon.png","direction":globals.FACING_LEFT},
    {
        ...
        "name": "Bob A",
        "condition": [ EVENT_HAS_NOT_FIRED, LOGGABLE_INTERACTION_3 ]
    },
    {
        "anim_type": globals.NPC_ANIM_TYPE_IDLE,
        "row": 8,
