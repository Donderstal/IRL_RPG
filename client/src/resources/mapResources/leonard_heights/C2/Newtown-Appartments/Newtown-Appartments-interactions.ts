...
export const KEY_GUY = [
    [
        ...
        [
            [[SceneAnimationType.speak, true, "Didn't I give you a key already", null]],
            [[SceneAnimationType.speak, true, "There's still no reason to go outside.", null]]
        ]
    ],
    [
        ...
        [
            [[SceneAnimationType.speak, true, "I guess you want to go outside, right?", null]],
            [[SceneAnimationType.speak, true, "I've locked the door, just to be sure...", null]],
            [[SceneAnimationType.speak, true, "But here's the key. Please lock it again when you go out!!", null]]
        ]
    ]
]
...
export const BODYGUARD = [
    [
        ...
        [ConditionType.default, false],
        [
            [[SceneAnimationType.speak, true, "I'm just here for the safety of my tenants.", null]],
            [[SceneAnimationType.speak, true, "Some maniac left the door unlocked.", null]]
        ]
    ]
]
...
export const WAITING_BUSINESSMAN = [
    [
        ...
        [ConditionType.default, false],
        [
            [[SceneAnimationType.speak, true, "For some reason somebody locked the main door...", null]],
            [[SceneAnimationType.emote, true, EMOTE_ANGRY, null]],
            [[SceneAnimationType.speak, true, "I don't have time for this! I've got important meetings to attend!!", null]]
        ]
    ]
]