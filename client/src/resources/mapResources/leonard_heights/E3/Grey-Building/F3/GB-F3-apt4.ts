...
export const MAP_LH_GB_F3_APT4 = {
    ...GBAptTemplate,
    "key": MAP_IDS.GREY_BUILDING_F3_APT4,
    "triggers": [...LHGB_AppartmentMain_Doors( MAP_IDS.GREY_BUILDING_F3_APT4 )]
}

export const MAP_LH_GB_F3_APT4_BED = {
    ...GBBedroomTemplate,
    "key": MAP_IDS.GREY_BUILDING_F3_APT4_BEDROOM,
    "triggers": [...LHGB_AppartmentBedroom_Doors( MAP_IDS.GREY_BUILDING_F3_APT4_BEDROOM )]
}

export const MAP_LH_GB_F3_APT4_TOILET = {
    ...GBToiletTemplate,
    "key": MAP_IDS.GREY_BUILDING_F3_APT4_TOILET,
    "triggers": [...LHGB_AppartmentToilet_Doors( MAP_IDS.GREY_BUILDING_F3_APT4_TOILET )]
}