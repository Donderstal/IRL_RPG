...
export const MAP_LH_GB_F1_APT1 = {
    ...GBAptTemplate,
    "key": MAP_IDS.GREY_BUILDING_F1_APT1,
    "triggers": [...LHGB_AppartmentMain_Doors( MAP_IDS.GREY_BUILDING_F1_APT1 )]
}

export const MAP_LH_GB_F1_APT1_BED = {
    ...GBBedroomTemplate,
    "key": MAP_IDS.GREY_BUILDING_F1_APT1_BEDROOM,
    "triggers": [...LHGB_AppartmentBedroom_Doors( MAP_IDS.GREY_BUILDING_F1_APT1_BEDROOM )]
}

export const MAP_LH_GB_F1_APT1_TOILET = {
    ...GBToiletTemplate,
    "key": MAP_IDS.GREY_BUILDING_F1_APT1_TOILET,
    "triggers": [...LHGB_AppartmentToilet_Doors( MAP_IDS.GREY_BUILDING_F1_APT1_TOILET )]
}