...
export const MAP_LH_GB_F1_APT3 = {
    ...GBAptTemplate,
    "key": MAP_IDS.GREY_BUILDING_F1_APT3,
    "triggers": [...LHGB_AppartmentMain_Doors( MAP_IDS.GREY_BUILDING_F1_APT3 )]
}

export const MAP_LH_GB_F1_APT3_BED = {
    ...GBBedroomTemplate,
    "key": MAP_IDS.GREY_BUILDING_F1_APT3_BEDROOM,
    "triggers": [...LHGB_AppartmentBedroom_Doors( MAP_IDS.GREY_BUILDING_F1_APT3_BEDROOM )]
}

export const MAP_LH_GB_F1_APT3_TOILET = {
    ...GBToiletTemplate,
    "key": MAP_IDS.GREY_BUILDING_F1_APT3_TOILET,
    "triggers": [...LHGB_AppartmentToilet_Doors( MAP_IDS.GREY_BUILDING_F1_APT3_TOILET )]
}