...
export const MAP_LH_GB_GF_APT2 = {
    ...GBAptTemplate,
    "key": MAP_IDS.GREY_BUILDING_GF_APT2,
    "triggers": [...LHGB_AppartmentMain_Doors( MAP_IDS.GREY_BUILDING_GF_APT2 )]
}

export const MAP_LH_GB_GF_APT2_BED = {
    ...GBBedroomTemplate,
    "key": MAP_IDS.GREY_BUILDING_GF_APT2_BEDROOM,
    "triggers": [...LHGB_AppartmentBedroom_Doors( MAP_IDS.GREY_BUILDING_GF_APT2_BEDROOM )]
}

export const MAP_LH_GB_GF_APT2_TOILET = {
    ...GBToiletTemplate,
    "key": MAP_IDS.GREY_BUILDING_GF_APT2_TOILET,
    "triggers": [...LHGB_AppartmentToilet_Doors( MAP_IDS.GREY_BUILDING_GF_APT2_TOILET )]
}